...
break     
case: 2:
      printf("regras do jogo:A regra geral é: vence a carta com o maior valor no atributo escolhido. Porém, para a Densidade Demográfica, a regra inverte: vence a carta com o menor valor.\n")
      break;  
 case 3:
      printf("Saindo...\n");
      break;
